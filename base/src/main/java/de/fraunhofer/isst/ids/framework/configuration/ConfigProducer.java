...
public class ConfigProducer {
    ...
    public ConfigProducer(final Serializer serializer, ConfigProperties properties) {
        try {
            ...
            var manager = new KeyStoreManager(configModel, properties.getKeyStorePassword().toCharArray(), properties.getTrustStorePassword().toCharArray(), properties.getKeyAlias());
